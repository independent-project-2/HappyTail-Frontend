...
function AddPets() {
    return (
        <div className='min-h-screen overflow-auto'>
            <div className='p-10 pt-15 flex flex-col text-black justify-center items-center'>
                ...
                >
                    ...
                    <span className='flex flex-col gap-1 p-4 border-solid border-2 border-gray-300 rounded-lg shadow-gray-500 shadow-lg'>
                        <div className='text-2xl font-bold m-1'>Basic Information</div>
                        ...
                        <div className='flex flex-col h-full'>
                            ...
                            <textarea
                                id="description"
                                className='border-solid border-2 border-gray-300 rounded-md p-1 h-full'
                            ></textarea>
                        </div>
                    ...
                    <div className='flex flex-col gap-4'>
                        ...
                        <span className='flex flex-col gap-2 h-full border-solid border-2 border-gray-300 p-5 rounded-lg shadow-gray-500 shadow-lg'>
                            ...
                            <div className='flex flex-row justify-center'>
                                ...
                                <div className='flex flex-row items-center-safe mr-10'>
                                ...
                                <div className='flex flex-row items-center-safe ml-10'>
                            ...
                            <div className='flex flex-col h-full'>
                                ...
                                <textarea
                                    id="health-notes"
                                    className='border-solid border-2 border-gray-300 rounded-md p-1 w-full h-fit '
                                ></textarea>
                            </div>
                        </span>
